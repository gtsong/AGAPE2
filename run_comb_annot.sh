...
$SCRIPTS/combined_annot.sh $out_name $comb_annot/more_more_annot $maker_dir/seq.fasta $comb_annot $comb_annot $snap_dir $SCRIPTS ENSEMBL 80 $comb_annot # results in $comb_annot/more_annot/gff/$out_name.genes.gff
